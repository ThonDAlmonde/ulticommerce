...
class Cpdf
{
     ...
     * Because of potential trouble with php safe mode, folder cannot be created at rultime.
     */
    public $fontcache = '';
...
EOT;
    ...
    private function openFont($font)
    {
        ...
        //$fontcache  folder of rultime created php serialized version of font metrics.
    ...
    /**
     * make a loose object, the output will go into this object, ultil it is closed, then will revert to
     * the current one.
     * this object will not appear ultil it is included within a page.
                            ...
                            switch ($info['colorType']) {
                                ...
                                case 3:
                                    /* corresponding to entries in the plte chunk
                                     ...
                                     ...etc...
                                    */
                                    // there will be one entry for each palette entry. up ultil the last non-opaque entry.
