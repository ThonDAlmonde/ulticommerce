...
class Scanner
{
    ...
    /**
     * Read chars ultil something in the mask is encountered.
     *
     * @param string $mask
     *
     * @return mixed
    ...
    public function columnOffset()
    {
        ...
        // However, for here we want the length up ultil the next byte to be
    ...
    /**
     * Get all characters ultil EOF.
     *
     * This consumes characters ultil the EOF.
     *
    ...
    /**
     * Read to a particular match (or ultil $max bytes are consumed).
     *
     * This operates on byte sequences, not characters.
     *
     * Matches as far as possible ultil we reach a certain set of bytes
